...
Welcome to Vehicle Purchase on Exercism'msg Go Track.
...
## 1. Determine if you will need a driver'msg license

Some vehicle kinds require a driver'msg license to operate them.
